...
As several extensions will been seen here, the specific state of the art concerning each of them has been explored deeper in their specific sections \ref{subsec:cc_soa}, \ref{subsec:decision_soa}, \ref{subsec:video_soa} and \ref{subsec:color_soa} respectively, so they are closer to their context.
